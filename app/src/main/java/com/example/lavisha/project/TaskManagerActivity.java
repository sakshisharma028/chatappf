...
import com.example.lavisha.project.data.TaskAdapter;
import com.example.lavisha.project.data.TaskContract;

import static com.example.lavisha.project.data.TaskContract.DATE_SORT;
import static com.example.lavisha.project.data.TaskContract.DEFAULT_SORT;

public class TaskManagerActivity extends AppCompatActivity implements
    ...
    public void onResume(){
        super.onResume();
        getLoaderManager().restartLoader(TASK_LOADER, null, TaskManagerActivity.this);
    }
